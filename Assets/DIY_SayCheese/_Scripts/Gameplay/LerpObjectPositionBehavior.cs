...
public class LerpObjectPositionBehavior : MonoBehaviour
{
    ...
    public void LerpObject(Transform lerpObject, Vector3 _finalPos, float speed, System.Action _lerpComplete = null, bool startLerpAuto = true)
    {
